...
func wireApp(confServer *conf.Server, dbCfg *conf.DatabaseConfig, authCfg *conf.AuthConfig, walletCfg *conf.WalletConfig, logger log.Logger) (*kratos.App, *job.SettlementJob, *biz.AdminUsecase, func(), error) {
	...
	httpServer := server.NewHTTPServer(confServer, authService, walletService, adminService, adminLegacyService, logger)
	app := newApp(logger, grpcServer, httpServer)
	return app, settlementJob, adminUsecase, func() {
		cleanup()
	}, nil
}
