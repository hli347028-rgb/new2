export default {
  ...
  community: {
    ...
    smallPerformance: 'Thành tích khu vực nhỏ',
  ...
  mine: {
    tokenAirdrop: 'Quyết toán thưởng',
    ...
    unexitedAmount: 'Số tiền chưa thoát',
    rewardDetail: 'Chi tiết thu nhập',
    staticIncome: 'Thu nhập tĩnh',
    generationReward: 'Thưởng thế hệ',
    communityBaseReward: 'Thưởng cộng đồng cơ bản',
    equalBonus: 'Cổ tức ngang cấp',
    totalNodes: 'Số đơn hàng',
    releaseCountdown: 'Đếm ngược giải phóng',
    none: 'Không',
    claimAirdrop: 'Rút tiền',
  ...
  node: {
    ...
    customAmount: 'Số tiền tùy chỉnh (≥ {min} USDT)',
    minPlaceholder: 'Tối thiểu {min}',
    minAmountTip: 'Số tiền đăng ký tối thiểu là {min} USDT',
    walletBalance: 'Số dư tài khoản',
    rechargeTip: 'Không giới hạn số tiền, nạp bất kỳ số tiền nào',
    rechargeSuccess: 'Nạp thành công',
    rechargeFailed: 'Nạp thất bại',
    rechargeAmountInvalid: 'Vui lòng nhập số tiền lớn hơn 0'
  },
  recharge: {
    recharge: 'Nạp tiền',
