export default {
  ...
  mine: {
    ...
    claimedAmount: '受取済額',
    remainingAmount: '残高',
    unexitedAmount: '未エグジット額',
    rewardDetail: '収益明細',
    staticIncome: '静的収益',
    generationReward: '代数報酬',
    communityBaseReward: 'コミュニティ基礎賞',
    equalBonus: '同レベル配当',
    totalNodes: '注文数',
  ...
  node: {
    ...
    statusCompleted: '完了',
    statusPending: '保留中',
    customAmount: 'カスタム金額 (≥ {min} USDT)',
    minPlaceholder: '最低 {min}',
    minAmountTip: '最低認購金額は {min} USDT です',
    walletBalance: '口座残高',
    rechargeTip: '金額制限なし、任意の金額でチャージ可能',
    rechargeSuccess: 'チャージ成功',
    rechargeFailed: 'チャージ失敗',
    rechargeAmountInvalid: '0より大きい金額を入力してください'
  },
  recharge: {
    recharge: 'チャージ',
