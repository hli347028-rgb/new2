export default {
  ...
  mine: {
    ...
    unexitedAmount: '미출국 금액',
    rewardDetail: '수익 상세',
    staticIncome: '정적 수익',
    generationReward: '대수 보상',
    communityBaseReward: '커뮤니티 기초상',
    equalBonus: '동급 배당',
    totalNodes: '주문 수',
  ...
  node: {
    ...
    statusCompleted: '완료',
    statusPending: '대기 중',
    customAmount: '직접 입력 (≥ {min} USDT)',
    minPlaceholder: '최소 {min}',
    minAmountTip: '최소 인수 금액은 {min} USDT입니다',
    walletBalance: '계정 잔액',
    rechargeTip: '금액 제한 없음, 원하는 금액으로 충전 가능',
    rechargeSuccess: '충전 성공',
    rechargeFailed: '충전 실패',
    rechargeAmountInvalid: '0보다 큰 금액을 입력하세요'
  },
  recharge: {
    recharge: '충전',
